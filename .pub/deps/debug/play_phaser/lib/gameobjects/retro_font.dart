...
class RetroFont extends RenderTexture {
   ...
   * @type {string}
   */
  static const String TEXT_SET1 = " !\"#\$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
   ...
   * @type {string}
   */
  static const String TEXT_SET2 = " !\"#\$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ";
   ...
   * @type {string}
   */
  static const String TEXT_SET3 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 ";
   ...
   * @type {string}
   */
  static const String TEXT_SET4 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789";
   ...
   * @type {string}
   */
  static const String TEXT_SET5 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ.,/() '!?-*:0123456789";
   ...
   * @type {string}
   */
  static const String TEXT_SET6 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ!?:;0123456789\"(),-.' ";
   ...
   * @type {string}
   */
  static const String TEXT_SET7 = "AGMSY+:4BHNTZ!;5CIOU.?06DJPV,(17EKQW\")28FLRX-'39";
   ...
   * @type {string}
   */
  static const String TEXT_SET8 = "0123456789 .ABCDEFGHIJKLMNOPQRSTUVWXYZ";
   ...
   * @type {string}
   */
  static const String TEXT_SET9 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ()-0123456789.:,'\"?!";
   ...
   * @type {string}
   */
  static const String TEXT_SET10 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
   ...
   * @type {string}
   */
  static const String TEXT_SET11 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ.,\"-+!?()':;0123456789";
  ...
  num characterWidth;
  num characterHeight;
  num characterSpacingX;
  num characterSpacingY;
  num characterPerRow;
  num offsetX;
  num offsetY;
  String align;
  ...
  :super(game, 100, 100, '', PIXI.scaleModes.NEAREST) {
     ...
     * @readonly
     */
    this.stamp = new Image(game, 0, 0, key, 0);

    //RenderTexture.call(this, game, 100, 100, '', Phaser.scaleModes.NEAREST);
